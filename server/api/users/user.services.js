...
// module.exports = {
//   register: (data, callback) => {
//     // console.log("registation", data, callback);
//     pool.query(
...
//     pool.query(
//       `SELECT 
//   registration.user_id,user_name,user_email, 
//   first_name, last_name FROM registration 
//   LEFT JOIN 
//   profile ON registration.user_id = profile.user_id 
